    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(max_length=50, verbose_name='Tipo Unidad')),
                ('alquiler', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transBack.Alquiler')),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transBack.Cliente')),
            ],
            options={
